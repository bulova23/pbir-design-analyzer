...
## Final 1.0.0 VSIX Files

The final `1.0.0` package set includes:
...
`1.0.0` is prepared for manual Marketplace upload by the release owner.

Keep all five target-specific VSIX files together for the same extension version and manually upload the full set for the `1.0.0` listing.
